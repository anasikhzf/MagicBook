...
class HiburanAdapterStaggered(private val hiburanList: List<HiburanData>) : RecyclerView.Adapter<HiburanAdapterStaggered.HiburanViewHolder>(){
    ...
    class HiburanViewHolder (itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val hiburanPenulis: MaterialTextView = itemView.findViewById(R.id.hiburan_penulis)
        val hiburanDescription: MaterialTextView = itemView.findViewById(R.id.hiburan_description)
        val hiburanImage: ShapeableImageView = itemView.findViewById(R.id.hiburan_image)
    }
